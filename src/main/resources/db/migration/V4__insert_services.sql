...
VALUES
    ...
    (UUID_TO_BIN(UUID()), 'Dog Neuter ', 'Surgical sterilization procedure for large-breed male dogs, including anesthesia and post-operative follow-up.', 280.00, 90, 'STERILIZATION'),
